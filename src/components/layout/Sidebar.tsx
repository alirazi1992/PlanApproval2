...
const primaryNav: SidebarNavItem[] = [
  { id: "dashboard", icon: "spark", label: "میز کار", path: "/dashboard" },
];
...
export function Sidebar() {
  ...
  const itemClass = (active: boolean) =>
    cn(
      ...
      "bg-white/50 text-gray-500 hover:text-gray-900 hover:bg-white shadow-[0_10px_25px_rgba(15,23,42,0.08)]",
      active &&
        "bg-gray-900 text-white shadow-[0_20px_40px_rgba(15,23,42,0.25)] scale-105"
    );

  return (
    <aside className="hidden lg:flex w-[88px] shrink-0 flex-col items-center py-6 gap-4">
